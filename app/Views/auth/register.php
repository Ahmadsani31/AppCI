                        ...
                        <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                            <div class="card-header no-border">
                                <div class="card-title text-xs-center">
                                    <img src="assets/images/logo/robust-logo-dark.png" alt="branding logo">
                                </div>
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    <form class="form-horizontal form-simple" action="register/store" method="POST" novalidate>
                                        <?= csrf_field(); ?>
                                        <?php if (session('validation')) : ?>
                                            <div class="alert alert-danger">Data error</div>
                                        <?php endif; ?>
                                        <fieldset class="form-group position-relative has-icon-left mb-1">
                                            <input type="text" class="form-control form-control-lg input-lg is-invalid" name="name" id="name" placeholder="Your Name" autofocus value="<?= old('name'); ?>">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left mb-1">
                                            <input type="email" class="form-control form-control-lg input-lg" name="email" id="email" placeholder="Your Email Address" required value="<?= old('email'); ?>">
                                            <div class="form-control-position">
                                                <i class="icon-mail6"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left mb-1">
                                            <input type="number" class="form-control form-control-lg input-lg" name="nope" id="nope" placeholder="Your number phone" required value="<?= old('nope'); ?>">
                                            <div class="form-control-position">
                                                <i class="icon-mail6"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left mb-1">
                                            <input type="text" class="form-control form-control-lg input-lg" name="username" id="username" placeholder="UserName" value="<?= old('username'); ?>">
                                            <div class="form-control-position">
                                                <i class="icon-head"></i>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left mb-0">
                                            <input type="password" class="form-control form-control-lg input-lg" name="password" id="password" placeholder="Enter Password">
                                            <div class="form-control-position">
                                                <i class="icon-key3"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control form-control-lg input-lg" name="repeat_password" id="repeat_password" placeholder="Repeat Your Password" required>
                                            <div class="form-control-position">
                                                <i class="icon-key3"></i>
                                            </div>
                                        </fieldset>
