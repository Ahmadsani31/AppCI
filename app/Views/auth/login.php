                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    <form class="form-horizontal form-simple" action="login/store" method="POST" novalidate>
                                        <?php csrf_field() ?>
                                        <?php if (session()->getFlashdata('message')) : ?>
                                            <div class="alert alert-success no-border mb-2" role="alert">
                                                <strong>Well done!</strong> <?= session()->getFlashdata('message'); ?>
                                            </div>
                                        <?php endif; ?>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control form-control-lg input-lg" name="username" id="username" placeholder="Your Username" required autofocus>
                            ...
                            <div class="card-footer">
                                <div class="">
                                    <p class="float-sm-left text-xs-center m-0"><a href="/admin/dashboard" class="card-link">Recover password</a></p>
                                    <p class="float-sm-right text-xs-center m-0">New to Robust? <a href="register" class="card-link">Sign Up</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
