    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><a href="/admin/dashboard" class="navbar-brand nav-link"><img alt="branding logo" src="../../assets/images/logo/robust-logo-light.png" data-expand="../../assets/images/logo/robust-logo-light.png" data-collapse="../../assets/images/logo/robust-logo-small.png" class="brand-logo"></a></li>
                ...
                <ul class="nav navbar-nav float-xs-right">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link">
                            <span class="avatar avatar-online"><img src="../../assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i>
                            </span><span class="user-name"><?= session()->get('name'); ?></span></a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="#" class="dropdown-item"><i class="icon-head"></i> Edit Profile</a><a href="#" class="dropdown-item"><i class="icon-mail6"></i> My Inbox</a>
                            ...
                            <a href="/singout" class="dropdown-item"><i class="icon-power3"></i>Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
